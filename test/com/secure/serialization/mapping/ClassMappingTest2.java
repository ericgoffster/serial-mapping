...
public class ClassMappingTest2 {
	...
	public static final ClassMapping<MySubObject> DESC = ClassMapping.of(
    		m -> new MySubObject(m.getInt("x"), m.getInt("y")),
    		new FieldDescription<>("x", MySubObject::getX, IntMapping.DESC),
    		new FieldDescription<>("y", MySubObject::getY, IntMapping.DESC));
