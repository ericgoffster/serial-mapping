...
public class YearMonthMappingTest2 {
	private static final DateTimeFormatter FORMAT = DateTimeFormatter.ofPattern("yyyy MMM");
	private static final YearMonthMapping DESC = YearMonthMapping.of(FORMAT);
